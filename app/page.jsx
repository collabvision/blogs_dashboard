...
export default function HomePage() {
  ...
  useEffect(() => {
    setMounted(true);
    // 1. Pull directly from LocalStorage
  ...
  const stripHtml = (html) => {
    if (typeof window === "undefined") return ""; // Security check for Next.js SSR
  ...
  return (
    <div className="bg-white text-black min-h-screen p-6 md:p-12">
      <header className="max-w-7xl mx-auto flex justify-between items-center border-b-8 border-black pb-8 mb-12">
        ...
        <Link
          href="/dashboard"
          className="bg-black text-white px-6 py-3 font-black hover:translate-x-1 hover:-translate-y-1 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all"
        >
          ADMIN DASHBOARD
        </Link>
      </header>
                ...
                <div className="border-4 border-black h-full bg-white flex flex-col shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] group-hover:shadow-none group-hover:translate-x-1 group-hover:translate-y-1 transition-all">
                  ...
                  <div className="h-56 border-b-4 border-black overflow-hidden bg-gray-100">
                    {blog.image ? (
                      ...
                      <div className="flex items-center justify-center h-full font-black text-gray-300">
                        NO IMAGE
                      </div>
                    )}
                  </div>
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    ...
                    <p className="text-[11px] font-medium text-gray-500 line-clamp-2 mb-4 leading-tight">
